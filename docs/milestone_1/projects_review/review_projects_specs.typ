...
#base-document.apply-base-document(
  ...
  Il capitolato, sicuramente interessante per la sua utilità pratica legata alla gestione documentale digitale, alla consultazione dei dati in totale indipendenza dalle condizioni della rete, oltre che all'idea di sviluppare una soluzione multi-piattaforma e autoconsistente. Essa però non ha però fatto particolarmente presa, fin dall’inizio, nel gruppo.\
  ...
  Il gruppo non ha dimostrato alcun interesse nei confronti del capitolato fin dalla presentazione avvenuta in aula. E’ sicuramente una proposta molto interessante, sia per l’impatto sociale del progetto che per l'integrazione con l’Intelligenza Artificiale. \
  _NoTIP_ ha però individuato diverse criticità. In primo luogo, la complessità tecnica e normativa legata alla gestione di dati estremamente sensibili la quale richiede una profonda competenza in sicurezza informatica, crittografia e conformità GDPR, ambiti poco consolidati tra gli elementi del gruppo. Inoltre, lo sviluppo di funzionalità avanzate basate sull’Intelligenza Artificiale, come il rilevamento linguistico dei segnali di abuso o la gestione del “panic button” intelligente, è risultato poco chiaro.\
  ...
  Durante il confronto effettuato con Eggon, sono emersi diversi aspetti positivi che hanno contribuito a valorizzare ulteriormente il capitolato. L’azienda si è mostrata molto disponibile e collaborativa, evidenziando fin da subito un approccio molto più orientato alla crescita reciproca piuttosto.\
  ...
  Fin dal primo momento, tale progetto, non ha riscosso particolare entusiasmo all’interno del gruppo. 
