...
#base-verbale.apply-base-verbale(
  ...
  Primo incontro tramite Google Meet con la proponente Eggon. L’incontro si è tenuto, sotto nostra richiesta per chiarire i dubbi che erano sorti nel gruppo durante la presentazione del capitolato e in successiva analisi.

  Il presente documento attesta che, in data 24 Ottobre 2025, l’avvenimento di un incontro conoscitivo con Eggon, in modalità virtuale su Google Meet.
  ...
  La riunione è stata effettuata per andare a rispondere principalmente alle seguenti questioni che, NoTIP, aveva già introdotto in una mail precedente all’incontro:
  #list(
    [OCR e AI Co-pilot],
  ...
  Eggon propone un’organizzazione flessibile, con 1-2 incontri settimanali di circa un’ora e supporto tecnico per 2-3 ore a settimana tramite email o Telegram. Verrà fornito un tool di tracking per le attività, e l’azienda si è resa disponibile per eventuali incontri in presenza presso la sede di Padova.
  ...
  Il gruppo NoTIP ringrazia l’azienda per il tempo dedicato, la trasparenza e la professionalità dimostrate.

  = Approvazione aziendale
  La presente sezione certifica che il verbale è stato esaminato e approvato dai rappresentanti di Eggon S.r.l.
